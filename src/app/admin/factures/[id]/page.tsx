...
import { ArrowLeft, Save, Loader2, Plus, Trash2, Download, CheckCircle } from "lucide-react";
...
export default function EditFacturePage({
  ...
  const tvaAmount = facture ? (sousTotal * facture.tva) / 100 : 0;
  ...
  if (!facture) {
    return (
      <div className="text-center py-12">
        ...
        <Link href="/admin/factures" className="text-accent hover:underline mt-4 inline-block">
          Retour à la liste
        </Link>
      </div>
    );
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Modifier les informations de la facture</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <a
            href={`/api/admin/factures/${id}/pdf`}
            target="_blank"
          ...
          {facture.status !== "PAYEE" && (
            <button
              type="button"
              onClick={() => setFacture({ ...facture, status: "PAYEE" })}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFacture({ ...facture, clientNom: e.target.value })
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFacture({ ...facture, clientEmail: e.target.value })
                }
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent"
                required
              />
            ...
            <div>
              ...
              <input
                type="tel"
                value={facture.clientTel || ""}
                onChange={(e) =>
                  setFacture({ ...facture, clientTel: e.target.value })
                }
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent"
              />
            </div>
            <div>
              ...
              <input
                type="text"
                value={facture.clientEntreprise || ""}
                onChange={(e) =>
                  setFacture({ ...facture, clientEntreprise: e.target.value })
                }
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent"
              />
            </div>
            <div className="md:col-span-2">
              ...
              <input
                ...
                onChange={(e) =>
                  setFacture({ ...facture, clientAdresse: e.target.value })
                }
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent"
              />
            </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      value={facture.tva}
                      onChange={(e) =>
                        setFacture({ ...facture, tva: Number(e.target.value) })
                      }
